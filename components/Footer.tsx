...
const REMIX_IDEAS = [
    "farklı saç stilleri denemek için.",
    "evcil hayvanınızı çizgi film karakterine dönüştürmek için.",
    "kendinizin fantastik bir versiyonunu yaratmak için.",
    "fotoğrafınıza dayalı bir süper kahraman tasarlamak için.",
    "kendinizi ünlü tarihi olayların içine yerleştirmek için.",
    "özel bir video oyunu avatarı oluşturmak için.",
];
        ...
        <footer className="fixed bottom-0 left-0 right-0 bg-black/50 backdrop-blur-sm p-3 z-50 text-neutral-300 text-xs sm:text-sm border-t border-white/10">
            <div className="max-w-screen-xl mx-auto flex justify-between items-center gap-4 px-4">
                ...
                <div className="hidden md:flex items-center gap-4 text-neutral-500 whitespace-nowrap">
                    <p>Gemini 2.5 Flash Image Preview ile güçlendirilmiştir</p>
                    <span className="text-neutral-700" aria-hidden="true">|</span>
                    <p>
                        Hikmet Tanrıverdi tarafından oluşturuldu
                    </p>
                </div>
                ...
                <div className="flex-grow flex justify-end items-center gap-4 sm:gap-6">
                    <div className="hidden lg:flex items-center gap-2 text-neutral-400 text-right min-w-0">
                        <span className="flex-shrink-0">Uygulamayı remixle...</span>
